exports.config = {
    ...
    //日程・結果のソースURL
    ,resultsUrl: "https://smartj.mobi/redsmylife/results.json?teamId=grampus&season="
    //順位表のソースURL
    ,standingsUrl: 'https://smartj.mobi/redsmylife/standings.json'
    //設定、メッセージのソースURL
    ,messageUrl: "https://smartj.mobi/redsmylife/config.json?teamId=grampus"
    //動画のソースURL
    ,videoUrl: "https://smartj.mobi/redsmylife/video.json?teamId=grampus"
    //報告URL
    ...
    //nend(iPhone)
    ,nendSpotIdIPhoneIcon: 236272
    ,nendApiKeyIPhoneIcon: 'e9dab0141da35e172335fe63e78327071893348d'
    ,nendSpotIdIPhoneBanner: 236271
    ,nendApiKeyIPhoneBanner: '593b5e565625251d325b0f30399762518ee1c0f3'
    //nend(Android)
